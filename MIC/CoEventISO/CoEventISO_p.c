...
const CInterfaceProxyVtbl * _CoEventISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * _CoEventISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoEventISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  _CoEventISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoEventISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoEventISO, pIID, n)

int __stdcall _CoEventISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoEventISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoEventISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoEventISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoEventISO_StubVtblList,
    (const PCInterfaceName * ) & _CoEventISO_InterfaceNamesList,
    (const IID ** ) & _CoEventISO_BaseIIDList,
    & _CoEventISO_IID_Lookup, 
    1,
    2,
