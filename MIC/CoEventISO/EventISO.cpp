// EventISO.cpp : Implementation of CEventISO
...
//1
STDMETHODIMP CEventISO::AllowWriteToDisk(VARIANT_BOOL vb)
{
...
//2
STDMETHODIMP CEventISO::AppendGUIValues(BSTR bstrfilename)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//3
STDMETHODIMP CEventISO::CollectParametersForNewISO(
	BSTR *pbstrNameOut,
...
//4
STDMETHODIMP CEventISO::CreateISO(VARIANT_BOOL *pvbSuccess)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//5
STDMETHODIMP CEventISO::DriveBBMToZero(
...
//6
STDMETHODIMP CEventISO::EstablishButtonKeeperCommunicationsPath(
...
//7
STDMETHODIMP CEventISO::EstablishSpecialUPSCommunicationsPath(
...
//8
STDMETHODIMP CEventISO::EstablishValidationCommunicationsPath(
...
//9
STDMETHODIMP CEventISO::get_CurrentBBM(ULONG *pCurrentBBM)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//10
STDMETHODIMP CEventISO::get_ID(BSTR *pbstrID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//11
STDMETHODIMP CEventISO::get_InShutDown(VARIANT_BOOL *pvbInShutDown)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//12
STDMETHODIMP CEventISO::get_InStartUp(VARIANT_BOOL *pvbInStartUp)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//13
STDMETHODIMP CEventISO::get_ISOCategory(ULONG *pCategory)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//14
STDMETHODIMP CEventISO::get_ISOTypeString(BSTR *pbstrTypeString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//15
STDMETHODIMP CEventISO::get_IsPaused(VARIANT_BOOL *pvbIsPaused)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//16
STDMETHODIMP CEventISO::get_FullName(BSTR *pbstrFullName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//17
STDMETHODIMP CEventISO::get_LastError(BSTR *pbstrErrorString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//18
STDMETHODIMP CEventISO::get_LocationAndExtensionsForDataFiles(
	BSTR *pbstrLocation,
...
//19
STDMETHODIMP CEventISO::get_Name(BSTR *pbstrName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//20
STDMETHODIMP CEventISO::get_VersionString(BSTR *pbstrVersion)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//21
STDMETHODIMP CEventISO::PauseInstrument(VARIANT_BOOL vbPauseCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//22
STDMETHODIMP CEventISO::put_DialogAutoCloseTime(ULONG seconds)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//23
STDMETHODIMP CEventISO::put_ICBPointer(IUnknown* pICB)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//24
STDMETHODIMP CEventISO::put_ICSOPointer(IUnknown* pICSO)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//25
STDMETHODIMP CEventISO::put_INIPathname(BSTR bstrINIPathname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//26
STDMETHODIMP CEventISO::put_LongNameFormatString(BSTR bstrFormatString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[128];
	Convert_BSTR_to_Character_String(
...
//27
STDMETHODIMP CEventISO::put_MaximumRetryRepetitions(ULONG uNumberRepetitions)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//28
STDMETHODIMP CEventISO::put_Name(BSTR bstrName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[MAX_PATH];
...
//29
STDMETHODIMP CEventISO::put_NormalShutdown(VARIANT_BOOL vbNormalShutdown)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//30
STDMETHODIMP CEventISO::put_UTILPathname(BSTR bstrUTILPathname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[MAX_PATH];
	Convert_BSTR_to_Character_String(
...
//31
STDMETHODIMP CEventISO::put_WindowsRegisteredMessageStrings(
	/*[in]*/ ULONG ulRECEIVE,
...
//32
STDMETHODIMP CEventISO::ResetISO()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	m_inst.Reset();
	return S_OK;
...
//33
STDMETHODIMP CEventISO::ShowISOGUI(VARIANT_BOOL vbCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//34
STDMETHODIMP CEventISO::ShutdownISO()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//35
STDMETHODIMP CEventISO::UPSGoDumb()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	m_inst.GoDumb();
	return S_OK;
...
//36
STDMETHODIMP CEventISO::UseShortFilename(VARIANT_BOOL vbCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
