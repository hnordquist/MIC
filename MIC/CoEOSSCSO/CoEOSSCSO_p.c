...
const CInterfaceProxyVtbl * _CoEOSSCSO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICSOProxyVtbl,
    0
};

const CInterfaceStubVtbl * _CoEOSSCSO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICSOStubVtbl,
    0
};

PCInterfaceName const _CoEOSSCSO_InterfaceNamesList[] = 
{
    "ICSO",
    0
};

const IID *  _CoEOSSCSO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoEOSSCSO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoEOSSCSO, pIID, n)

int __stdcall _CoEOSSCSO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoEOSSCSO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoEOSSCSO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoEOSSCSO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoEOSSCSO_StubVtblList,
    (const PCInterfaceName * ) & _CoEOSSCSO_InterfaceNamesList,
    (const IID ** ) & _CoEOSSCSO_BaseIIDList,
    & _CoEOSSCSO_IID_Lookup, 
    1,
    2,
