...
#ifndef __CoEOSSCSO_h__
#define __CoEOSSCSO_h__
...
#ifndef __EOSSCSO_FWD_DEFINED__
#define __EOSSCSO_FWD_DEFINED__

#ifdef __cplusplus
typedef class EOSSCSO EOSSCSO;
#else
typedef struct EOSSCSO EOSSCSO;
#endif /* __cplusplus */

#endif 	/* __EOSSCSO_FWD_DEFINED__ */
...
#ifndef __COEOSSCSOLib_LIBRARY_DEFINED__
#define __COEOSSCSOLib_LIBRARY_DEFINED__

/* library COEOSSCSOLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_COEOSSCSOLib;

EXTERN_C const CLSID CLSID_EOSSCSO;

#ifdef __cplusplus

class DECLSPEC_UUID("6710F5EB-794B-485b-945E-345EBBA3FFC3")
EOSSCSO;
#endif
#endif /* __COEOSSCSOLib_LIBRARY_DEFINED__ */
