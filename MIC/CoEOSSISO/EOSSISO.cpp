// EOSSISO.cpp : Implementation of CEOSSISO
...
//1
STDMETHODIMP CEOSSISO::AllowWriteToDisk(VARIANT_BOOL vb)
{
...
//2
STDMETHODIMP CEOSSISO::AppendGUIValues(BSTR bstrfilename)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//3
STDMETHODIMP CEOSSISO::CollectParametersForNewISO(
	BSTR *pbstrNameOut,
...
//4
STDMETHODIMP CEOSSISO::CreateISO(VARIANT_BOOL *pvbSuccess)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//5
STDMETHODIMP CEOSSISO::DriveBBMToZero(
...
//6
STDMETHODIMP CEOSSISO::EstablishButtonKeeperCommunicationsPath(
...
//7
STDMETHODIMP CEOSSISO::EstablishSpecialUPSCommunicationsPath(
...
//8
STDMETHODIMP CEOSSISO::EstablishValidationCommunicationsPath(
...
//9
STDMETHODIMP CEOSSISO::get_CurrentBBM(ULONG *pCurrentBBM)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//10
STDMETHODIMP CEOSSISO::get_ID(BSTR *pbstrID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//11
STDMETHODIMP CEOSSISO::get_InShutDown(VARIANT_BOOL *pvbInShutDown)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//12
STDMETHODIMP CEOSSISO::get_InStartUp(VARIANT_BOOL *pvbInStartUp)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//13
STDMETHODIMP CEOSSISO::get_ISOCategory(ULONG *pCategory)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//14
STDMETHODIMP CEOSSISO::get_ISOTypeString(BSTR *pbstrTypeString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//15
STDMETHODIMP CEOSSISO::get_IsPaused(VARIANT_BOOL *pvbIsPaused)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//16
STDMETHODIMP CEOSSISO::get_FullName(BSTR *pbstrFullName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//17
STDMETHODIMP CEOSSISO::get_LastError(BSTR *pbstrErrorString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//18
STDMETHODIMP CEOSSISO::get_LocationAndExtensionsForDataFiles(
	BSTR *pbstrLocation,
...
//19
STDMETHODIMP CEOSSISO::get_Name(BSTR *pbstrName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//20
STDMETHODIMP CEOSSISO::get_VersionString(BSTR *pbstrVersion)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//21
STDMETHODIMP CEOSSISO::PauseInstrument(VARIANT_BOOL vbPauseCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//22
STDMETHODIMP CEOSSISO::put_DialogAutoCloseTime(ULONG seconds)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//23
STDMETHODIMP CEOSSISO::put_ICBPointer(IUnknown* pICB)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//24
STDMETHODIMP CEOSSISO::put_ICSOPointer(IUnknown* pICSO)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//25
STDMETHODIMP CEOSSISO::put_INIPathname(BSTR bstrINIPathname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//26
STDMETHODIMP CEOSSISO::put_LongNameFormatString(BSTR bstrFormatString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[128];
	Convert_BSTR_to_Character_String(
...
//27
STDMETHODIMP CEOSSISO::put_MaximumRetryRepetitions(ULONG uNumberRepetitions)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//28
STDMETHODIMP CEOSSISO::put_Name(BSTR bstrName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[MAX_PATH];
...
//29
STDMETHODIMP CEOSSISO::put_NormalShutdown(VARIANT_BOOL vbNormalShutdown)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//30
STDMETHODIMP CEOSSISO::put_UTILPathname(BSTR bstrUTILPathname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[MAX_PATH];
	Convert_BSTR_to_Character_String(
...
//31
STDMETHODIMP CEOSSISO::put_WindowsRegisteredMessageStrings(
	/*[in]*/ ULONG ulRECEIVE,
...
//32
STDMETHODIMP CEOSSISO::ResetISO()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	m_inst.Reset();
	return S_OK;
...
//33
STDMETHODIMP CEOSSISO::ShowISOGUI(VARIANT_BOOL vbCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//34
STDMETHODIMP CEOSSISO::ShutdownISO()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//35
STDMETHODIMP CEOSSISO::UPSGoDumb()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	m_inst.GoDumb();
	return S_OK;
...
//36
STDMETHODIMP CEOSSISO::UseShortFilename(VARIANT_BOOL vbCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
