...
typedef struct tagSTATUS {
   ...
   unsigned short FlashWarnings;	//2	16
   unsigned short FlashErrors;		//2	18	
   unsigned short MajoWarnings;		//2 20
   unsigned short MajoErrors;		//2 22

   unsigned short EPROMCrc16;		//2 24
   unsigned char BatID[8];			//8 26
   char BatteryType[8];				//8 34
   unsigned short BatteryMfg;		//2 42
   unsigned long BatteryConsumed;	//4 44

   unsigned short EBatteryMfg;		//2 48
   unsigned long EBatteryConsumed;	//4 50
   unsigned short BatteryInstalled;	//2 52

   unsigned short EBatteryInstalled;//2 54
   signed short T0Offset;			//2 56
   signed short F0Offset;			//2 58
   unsigned short LaserThreshold;	//2 60

   unsigned short Laser500uW;		//2 62
   unsigned short LaserPeak;		//2 64
   unsigned short LaserAdjDate;		//2 66
   char LaserId[16];				//16 68 
   unsigned long VacossAttachments;	//4 84
   unsigned char VacossEnabled;		//1 88

   unsigned char Reserved[5];		//5 89
} STATUS;							//total 94
