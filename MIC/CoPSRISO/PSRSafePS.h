...
// PSRSafePS.h : header file

#include "ccbutton.h"
#include "JulianT.h"

#define PSRACQUIRERECCCOUNT			32
...
#define PSR_STATUS_RECORD_LENGTH		10
#define PSR_HV_RECORD_LENGTH			6
#define PSR_VERSION_RECORD_LENGTH		17
#define PSR_DATA_RECORD_LENGTH			62
#define PSR_SETUP_RECORD_LENGTH			20
#define PSR_SETUP_RECORD_LENGTH2		21
#define PSR_AUX_RECORD_LENGTH			15
#define PSR_READ_RECORD_LENGTH			57
#define PSR_STATUS_RECORD_ERR_LENGTH	58

#define PSR_STATUS_RECORD		10
#define PSR_HV_RECORD			6
#define PSR_VERSION_RECORD		17
#define PSR_DATA_RECORD			62
#define PSR_SETUP_RECORD		20
#define PSR_AUX_RECORD			15
#define PSR_READ_RECORD			57
#define PSR_UNKNOWN_RECORD		58
...
class CPSRPropertySheet : public CPropertySheet
{
	DECLARE_DYNAMIC(CPSRPropertySheet)
...
public:
	...
	bool WriteToPSRFile(CJulianTime* Time, PSRAcquireRecord* AcquireRec);
...
public:
	...
	char			m_szCurrentPSRFileName[_MAX_PATH];
	...
	struct PSRAcquireRecord PSRAcquireRec;
...
protected:
	...
	PSRAcquireRecord SumAcquireRec;
