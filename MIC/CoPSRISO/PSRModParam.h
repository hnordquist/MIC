...
#ifndef PSRMODPARAM_H
#define PSRMODPARAM_H
...
#define PSR_DEFAULT "PSR Default"
///////////////////////////////////////////////////////////////////////////
// CModParam dialog
class CPSRModParam : public CPropertyPage
{
	DECLARE_DYNCREATE(CPSRModParam)

// Construction
public:
	CPSRModParam(UINT id, CISO* pParent, bool DoingConfig = false);
	CPSRModParam();
	~CPSRModParam();
...
//Variables
	...
	bool m_bSaved;
	//On configuring a new PSR, m_pPropertySheet is CTPropertySheet.
	//All other times, m_pPropertySheet is CPSRPropertySheet.
	CTPropertySheet *m_pPS;
	COLORREF StaticColors[IDC_PSRMODPARAMS_LAST-IDC_PSRMODPARAMS_FIRST+1];
	bool m_bDataSetup;
	bool m_bChange;
	CISO* m_pParent;
	CSimpleYellowButton	*m_pApplyButton;
	CSimpleYellowButton *m_pApplyPSRButton;  
...
// Dialog Data
	//{{AFX_DATA(CPSRModParam)
	enum { IDD = IDD_PSRMODPARAMS_PAGE };
	//}}AFX_DATA

// Overrides
	// ClassWizard generate virtual function overrides
	//{{AFX_VIRTUAL(CPSRModParam)
	public:
...
protected:
	...
	//{{AFX_MSG(CPSRModParam)
	afx_msg void OnModparamsApply();
	afx_msg void OnModparamsApplyPSR();
