...
const CInterfaceProxyVtbl * _CoILONCSO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICSOProxyVtbl,
    0
};

const CInterfaceStubVtbl * _CoILONCSO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICSOStubVtbl,
    0
};

PCInterfaceName const _CoILONCSO_InterfaceNamesList[] = 
{
    "ICSO",
    0
};

const IID *  _CoILONCSO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoILONCSO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoILONCSO, pIID, n)

int __stdcall _CoILONCSO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoILONCSO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoILONCSO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoILONCSO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoILONCSO_StubVtblList,
    (const PCInterfaceName * ) & _CoILONCSO_InterfaceNamesList,
    (const IID ** ) & _CoILONCSO_BaseIIDList,
    & _CoILONCSO_IID_Lookup, 
    1,
    2,
