...
#define UGRAND_DEFAULT		"uGRAND Default"
...
#define BATVOLTH_SPIN_DEF	"3.0"
#define BATVOLTH_SPIN_MAX	40
#define BATVOLTH_SPIN_MIN	0
#define BATVOLTL_SPIN_MAX	40
#define BATVOLTL_SPIN_MIN	0
#define BATVOLTL_SPIN_DEF	"0.0"

#define SUP_P25H_SPIN_DEF	"2.5"
#define SUP_P25H_SPIN_MAX	30
#define SUP_P25H_SPIN_MIN	20
#define SUP_P25L_SPIN_MAX	30
#define SUP_P25L_SPIN_MIN	20
#define SUP_P25L_SPIN_DEF	"2.5"

#define FCHVERR_DEF			5
#define FCHVERR_MAX			10
...
#define SUP_P33H_SPIN_DEF	"3.3"
#define SUP_P33H_SPIN_MAX	40
#define SUP_P33H_SPIN_MIN	20
#define SUP_P33L_SPIN_MAX	40
#define SUP_P33L_SPIN_MIN	20
#define SUP_P33L_SPIN_DEF	"3.3"
...
#define SAVELOC_DEF			"C:\\DATA\\uGRAND01"
...
: CPropertyPage(id)
{
	...
	//<<QA>> I suspect not.
	m_pUGrandSetup = new CUGrandSetup(this, m_szIniFile);
}

CModParam::~CModParam()
{
	delete m_pApplyButton;
	delete m_pUGrandSetup;
}
...
BEGIN_MESSAGE_MAP(CModParam, CPropertyPage)
	...
	ON_NOTIFY(UDN_DELTAPOS, IDC_MODPARAMS_SUP_P33L_SPIN, OnDeltaposModparamsSupP33lSpin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_MODPARAMS_SUP_P33H_SPIN, OnDeltaposModparamsSupP33hSpin)
	...
	ON_NOTIFY(UDN_DELTAPOS, IDC_MODPARAMS_SUP_P25H_SPIN, OnDeltaposModparamsSupP25hSpin)
	ON_NOTIFY(UDN_DELTAPOS, IDC_MODPARAMS_SUP_P25L_SPIN, OnDeltaposModparamsSupP25lSpin)
	...
	ON_EN_CHANGE(IDC_MODPARAMS_SUP_P25L, OnChangeModparamsMost)
	ON_EN_CHANGE(IDC_MODPARAMS_SUP_P25H, OnChangeModparamsMost)
	ON_EN_CHANGE(IDC_MODPARAMS_SUP_P05L, OnChangeModparamsMost)
	ON_EN_CHANGE(IDC_MODPARAMS_SUP_P05H, OnChangeModparamsMost)
	ON_EN_CHANGE(IDC_MODPARAMS_SUP_P33L, OnChangeModparamsMost)
	ON_EN_CHANGE(IDC_MODPARAMS_SUP_P33H, OnChangeModparamsMost)
...
{
	if (m_pUGrandSetup)
		m_pUGrandSetup->ShowWindow(SW_HIDE);
}
...
void CModParam::DoApply()
{
	...
	SaveItem(Name,"SUP_P25H",	IDC_MODPARAMS_SUP_P25H);
	SaveItem(Name,"SUP_P25L",	IDC_MODPARAMS_SUP_P25L);
	SaveItem(Name,"SUP_P33H",	IDC_MODPARAMS_SUP_P33H);
	SaveItem(Name,"SUP_P33L",	IDC_MODPARAMS_SUP_P33L);	
...
void CModParam::OnModparamsReset() 
{
	...
	ResetItem(m_pName,"SUP_P25H",SUP_P25H_SPIN_DEF,
		IDC_MODPARAMS_SUP_P25H_SPIN,SUP_P25H_SPIN_MIN,SUP_P25H_SPIN_MAX,
		IDC_MODPARAMS_SUP_P25H);

	ResetItem(m_pName,"SUP_P25L",SUP_P25L_SPIN_DEF,
		IDC_MODPARAMS_SUP_P25L_SPIN,SUP_P25L_SPIN_MIN,SUP_P25L_SPIN_MAX,
		IDC_MODPARAMS_SUP_P25L);

	ResetItem(m_pName,"SUP_P33H",SUP_P33H_SPIN_DEF,
		IDC_MODPARAMS_SUP_P33H_SPIN,SUP_P33H_SPIN_MIN,SUP_P33H_SPIN_MAX,
		IDC_MODPARAMS_SUP_P33H);

	ResetItem(m_pName,"SUP_P33L",SUP_P33L_SPIN_DEF,
		IDC_MODPARAMS_SUP_P33L_SPIN,SUP_P33L_SPIN_MIN,SUP_P33L_SPIN_MAX,
		IDC_MODPARAMS_SUP_P33L);	
...
void CModParam::DoBuddySpin(NMHDR* pNMHDR, LRESULT* pResult, int MIN, int MAX, 
							int DLGITEM, int DLGITEMBUDDY, int SPINNER, bool bAbove)
{
...
//	if "uGRAND" at end of name
	Text.MakeReverse();
	switch (Text.Find("DNARGu"))
	{
	case 0:
		Text.MakeReverse();
		break;
...
void CModParam::OnDeltaposModparamsSupP33hSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	if (m_pPS) m_pPS->SetToClose(0);
	DoBuddySpin(pNMHDR, pResult, SUP_P33H_SPIN_MIN, SUP_P33H_SPIN_MAX, 
		IDC_MODPARAMS_SUP_P33H, IDC_MODPARAMS_SUP_P33L, IDC_MODPARAMS_SUP_P33L_SPIN, false);
}

void CModParam::OnDeltaposModparamsSupP33lSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	if (m_pPS) m_pPS->SetToClose(0);
	DoBuddySpin(pNMHDR, pResult, SUP_P33L_SPIN_MIN, SUP_P33L_SPIN_MAX, 
		IDC_MODPARAMS_SUP_P33L, IDC_MODPARAMS_SUP_P33H, IDC_MODPARAMS_SUP_P33H_SPIN,true);
}
...
void CModParam::OnDeltaposModparamsSupP25hSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	if (m_pPS) m_pPS->SetToClose(0);
	DoBuddySpin(pNMHDR, pResult, SUP_P25H_SPIN_MIN, SUP_P25H_SPIN_MAX, 
		IDC_MODPARAMS_SUP_P25H, IDC_MODPARAMS_SUP_P25L, IDC_MODPARAMS_SUP_P25L_SPIN, false);
}

void CModParam::OnDeltaposModparamsSupP25lSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	if (m_pPS) m_pPS->SetToClose(0);
	DoBuddySpin(pNMHDR, pResult, SUP_P25L_SPIN_MIN, SUP_P25L_SPIN_MAX, 
		IDC_MODPARAMS_SUP_P25L, IDC_MODPARAMS_SUP_P25H, IDC_MODPARAMS_SUP_P25H_SPIN, true);
}
...
void CModParam::OnModparamsDefault(bool SetPort)
{
	...
	ResetItem(UGRAND_DEFAULT, FILE_ID, FILEID_SPIN_DEF,  
		IDC_MODPARAMS_FILEID_SPIN, IDC_MODPARAMS_FILEID);

	ResetItem(UGRAND_DEFAULT, "BATVOLTH", BATVOLTH_SPIN_DEF,  
		IDC_MODPARAMS_BATVOLTH_SPIN, BATVOLTH_SPIN_MIN, BATVOLTH_SPIN_MAX,
		IDC_MODPARAMS_BATVOLTH);

	ResetItem(UGRAND_DEFAULT, "BATVOLTL", BATVOLTL_SPIN_DEF,
		IDC_MODPARAMS_BATVOLTL_SPIN, BATVOLTL_SPIN_MIN, BATVOLTL_SPIN_MAX,
		IDC_MODPARAMS_BATVOLTL);

	ResetItem(UGRAND_DEFAULT,"SUP_P25H",SUP_P25H_SPIN_DEF,
		IDC_MODPARAMS_SUP_P25H_SPIN,SUP_P25H_SPIN_MIN,SUP_P25H_SPIN_MAX,
		IDC_MODPARAMS_SUP_P25H);

	ResetItem(UGRAND_DEFAULT,"SUP_P25L",SUP_P25L_SPIN_DEF,
		IDC_MODPARAMS_SUP_P25L_SPIN,SUP_P25L_SPIN_MIN,SUP_P25L_SPIN_MAX,
		IDC_MODPARAMS_SUP_P25L);

	ResetItem(UGRAND_DEFAULT,"SUP_P33H",SUP_P33H_SPIN_DEF,
		IDC_MODPARAMS_SUP_P33H_SPIN,SUP_P33H_SPIN_MIN,SUP_P33H_SPIN_MAX,
		IDC_MODPARAMS_SUP_P33H);

	ResetItem(UGRAND_DEFAULT,"SUP_P33L",SUP_P33L_SPIN_DEF,
		IDC_MODPARAMS_SUP_P33L_SPIN,SUP_P33L_SPIN_MIN,SUP_P33L_SPIN_MAX,
		IDC_MODPARAMS_SUP_P33L);	

	ResetItem(UGRAND_DEFAULT,"SUP_P05H",SUP_P05H_SPIN_DEF,
		IDC_MODPARAMS_SUP_P05H_SPIN,SUP_P05H_SPIN_MIN,SUP_P05H_SPIN_MAX,
		IDC_MODPARAMS_SUP_P05H);

	ResetItem(UGRAND_DEFAULT,"SUP_P05L",SUP_P05L_SPIN_DEF,
		IDC_MODPARAMS_SUP_P05L_SPIN,SUP_P05L_SPIN_MIN,SUP_P05L_SPIN_MAX,
		IDC_MODPARAMS_SUP_P05L);

	ResetItem(UGRAND_DEFAULT,"TIME_ERR",TIME_ERR_SPIN_DEF,
		IDC_MODPARAMS_TIME_ERR_SPIN,TIME_ERR_SPIN_MIN,TIME_ERR_SPIN_MAX);

	ResetItem(UGRAND_DEFAULT,"SLOW_RESET",SLOW_RESET_SPIN_DEF,
		IDC_MODPARAMS_SLOW_RESET_SPIN,SLOW_RESET_SPIN_MIN,SLOW_RESET_SPIN_MAX);
	
	ResetItem(UGRAND_DEFAULT,"MAXCYCLE",MAXCYCLE_SPIN_DEF,
		IDC_MODPARAMS_MAXCYCLE_SPIN,MAXCYCLE_SPIN_MIN,MAXCYCLE_SPIN_MAX);

	ResetItem(UGRAND_DEFAULT,"DO_DUMP",DODUMP_DEF,IDC_MODPARAMS_DODUMP);

	ResetItem(UGRAND_DEFAULT,"BINARY_BBM",BINARY_BBM_DEF,IDC_CHECK_BINARY);

	ResetItem(UGRAND_DEFAULT,"LBREXTEND", LBREXTEND_DEF,IDC_CHECK_LBREXTEND);

	ResetItem(UGRAND_DEFAULT,"LOG_FILTER",LOGFILTER_DEF,IDC_MODPARAMS_LOGFILTER);

	ResetItem(UGRAND_DEFAULT,"LOG_MII",LOGMII_DEF,IDC_MODPARAMS_LOGMII);

	ResetItem(UGRAND_DEFAULT,"AUTOTIMESET",AUTOTIME_DEF,IDC_CHECK_ALLOWAUTODATE);
 
	ResetItem(UGRAND_DEFAULT,SAVE_LOC,SAVELOC_DEF,IDC_MODPARAMS_SAVELOC);

	if (SetPort || m_bCollectingParametersForNewISO)
	{
		ResetItem(UGRAND_DEFAULT,NODE,NODE_SPIN_DEF,
			IDC_MODPARAMS_NODE_SPIN,NODE_SPIN_MIN,NODE_SPIN_MAX);
		...
		ResetItem(UGRAND_DEFAULT,PORT,PORT_DEF,IDC_MODPARAMS_PORT);
	}

	ResetItem(UGRAND_DEFAULT,"MAXINQUIRE",MAXINQUIRE_SPIN_DEF,
		IDC_MODPARAMS_MAXINQUIRE_SPIN,MAXINQUIRE_SPIN_MIN,MAXINQUIRE_SPIN_MAX);

	ResetItem(UGRAND_DEFAULT,"MAXSTATUS",MAXSTATUS_SPIN_DEF,
		IDC_MODPARAMS_MAXSTATUS_SPIN,MAXSTATUS_SPIN_MIN,MAXSTATUS_SPIN_MAX);

	ResetItem(UGRAND_DEFAULT,"COMMFAIL",COMMFAIL_SPIN_DEF,
		IDC_MODPARAMS_COMMFAIL_SPIN,COMMFAIL_SPIN_MIN,COMMFAIL_SPIN_MAX);

	ResetItem(UGRAND_DEFAULT,"TIMEOUT",TIMEOUT_SPIN_DEF,
		IDC_MODPARAMS_TIMEOUT_SPIN,TIMEOUT_SPIN_MIN,TIMEOUT_SPIN_MAX);

	ResetItemI(UGRAND_DEFAULT,"MAXPAUSE",MAXPAUSE_SPIN_DEF,
		IDC_MODPARAMS_MAXPAUSE_SPIN,MAXPAUSE_SPIN_MIN,MAXPAUSE_SPIN_MAX,IDC_MODPARAMS_MAXPAUSE);

	ResetItemI(UGRAND_DEFAULT,"MAXBBM",MAXBBM_SPIN_DEF,
		IDC_MODPARAMS_MAXBBM_SPIN,MAXBBM_SPIN_MIN,MAXBBM_SPIN_MAX,IDC_MODPARAMS_MAXBBM);

	ResetItem(UGRAND_DEFAULT,"ICHVERR",ICHVERR_DEF,
		IDC_MODPARAMS_ICHVERR_SPIN,ICHVERR_MIN,ICHVERR_MAX);

	ResetItem(UGRAND_DEFAULT,"FCHVERR",FCHVERR_DEF,
		IDC_MODPARAMS_FCHVERR_SPIN,FCHVERR_MIN,FCHVERR_MAX);
}
...
{
	if (m_pUGrandSetup)
		m_pUGrandSetup->AddSetParam(szDesc,szIniName,szSetting,szCommand,uLength);
}

void CModParam::CurrentSetParam(char*szIniName,char*szCurrent,bool bModParam,bool bTextOnly)
{
	if (m_pUGrandSetup)
		m_pUGrandSetup->CurrentSetParam(szIniName,szCurrent,bModParam,bTextOnly);
}
...
void CModParam::OnShowWindow(BOOL bShow, UINT nStatus) 
{
	...
	if (m_bShowingUGrandSetupDialog && m_pUGrandSetup)
		m_pUGrandSetup->ShowWindow(bShow);
}
...
{
	if (m_bShowingUGrandSetupDialog)
	{
		if (m_pUGrandSetup)
			m_pUGrandSetup->ShowWindow(SW_HIDE);

		m_bShowingUGrandSetupDialog = false;
	}
	else
	{
		if (m_pUGrandSetup)
			m_pUGrandSetup->ShowWindow(SW_SHOW);

		m_bShowingUGrandSetupDialog = true;
	}
}
...
BOOL CModParam::OnInitDialog() 
{
	...
	if (m_pUGrandSetup)
	{
		m_pUGrandSetup->Create(IDD_UGRANDSETUP_DIALOG,this);
		m_pUGrandSetup->ShowWindow(SW_HIDE);
	}
	m_bShowingUGrandSetupDialog = false;
...
//			szTemp[0] = NULL;
//			GetPrivateProfileString(UGRAND_DEFAULT,pszIniName,"",szTemp,sizeof(szTemp),m_szIniFile);
//			if (strlen(szTemp)==0)
...
//	}
	...
	if (m_pUGrandSetup)
	{
		m_pUGrandSetup->SetWindowText(m_pName);
		strcpy(m_pUGrandSetup->m_szName,m_pName);
	}
...
void CModParam::IssuePrint(FILE *outfile)
{
	...
	GetDlgItemText(IDC_MODPARAMS_SUP_P25H,temp);
	GetDlgItemText(IDC_MODPARAMS_SUP_P25L,temp1);
	fprintf(outfile,"    2.5 Volt Supply: %6s  %6s\n",temp,temp1);
	GetDlgItemText(IDC_MODPARAMS_SUP_P33H,temp);
	GetDlgItemText(IDC_MODPARAMS_SUP_P33L,temp1);
	fprintf(outfile,"    3.3 Volt Supply: %6s  %6s\n",temp,temp1);
...
//	TRACE("CModParam::WriteIniFileDefaultSection()\n");
	...
	WritePrivateProfileSection(UGRAND_DEFAULT,"",m_szIniFile);

	WritePrivateProfileString(UGRAND_DEFAULT,"SLOW_RESET","900",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"BATVOLTH","3.0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"BATVOLTL","2.0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SUP_P25H","2.6",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SUP_P25L","2.4",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SUP_P33H","3.4",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SUP_P33L","3.2",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SUP_P05H","5.3",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SUP_P05L","4.7",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"TIME_ERR","60",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SLOW_RESET","900",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"NODE","-1",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"PORT","",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"FLAGCOMM","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"FLAGOTHR","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"FLAGTIME","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"MAXCYCLE","1000",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"MAXPAUSE","5400",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"DO_DUMP","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"LOG_FILTER","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"LOG_MII","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,SAVE_LOC,"C:\\DATA\\uGRAND01",m_szIniFile);

	WritePrivateProfileString(UGRAND_DEFAULT,"MAXINQUIRE","30",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"MAXSTATUS","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"COMMFAIL","5",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"AUTOTIMESET","1",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"LBREXTEND","0",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"TIMEOUT","5",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"BINARY_BBM","1",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"MAXBBM","100",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT, FILE_ID,"01",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"ICHVERR","10",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"FCHVERR","5",m_szIniFile);
...
//		pszDefault = cUGrandSetupData.GetNext();
//		pszCommand = cUGrandSetupData.GetNext();
//		WritePrivateProfileString(UGRAND_DEFAULT,pszIniName,pszDefault,m_szIniFile);
//	}
	while ((pszDescription = cUGrandSetupData.GetNext())!=NULL)
	{
		pszIniName = cUGrandSetupData.GetNext();
...
/*
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ACQ_MODE12","\"1F\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ACQ_MODE1B","\"2\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_1B_ROM_CHECKSUM","\"0000\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_LLD_A","\"  0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_LLD_B","\"  0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ULD_A","\"  0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ULD_B","\"  0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_UNIT_ID","\"11\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_BOARD1_ID","\"07\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_BOARD2_ID","\"06\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_USER_ID","\"7777777\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_GAMMA1_MODE","\"A\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_GAMMA2_MODE","\"A\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_MAX_GAIN0","\"4194304\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_MAX_GAIN1","\"4194304\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_DISCONNECT_MODE","\"I\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_UGRAND_USERVER","\"03.76\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_VERSION","\"03.76\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ACQUIRE_TIME","\"    1\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_BUFFER_TOTAL","\"70\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_BUFFER_SAVE","\"50\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NEUTRON_PULSEATHRESH","\"   100.0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NEUTRON_PULSEBTHRESH","\"   100.0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NEUTRON_PULSECTHRESH","\"   100.0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_GAMMA_1THRESH","\"     100.0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_GAMMA_2THRESH","\"     100.0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NOFILTERENTERMII_RUNS","\" 3\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NOFILTERENTERMII_SIGMA","\"3.0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ENTERMII_RUNS","\" 3\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ENTERMII_SIGMA","\"1.5\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_MII_EXIT","\"10\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_LOCAL_BACKGROUND_FIRST","\"25\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_LOCAL_BACKGROUND_LAST","\"30\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_ACQ_MODE1C","\"1f\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_1C_ROM_CHECKSUM","\"0000\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_FILTER_METHOD","\"0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_TRIGGER_MODE","\"1\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_TAKE_OFFSET","\" 24\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_TAKEOFFSETMAX","\" 48\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_LOG_BATTERY","\" 1\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_FILTERING_ENABLED","\"0\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NEUTRON_A_LOWERLIMIT","\"0.200\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NEUTRON_B_LOWERLIMIT","\"0.200\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_NEUTRON_C_LOWERLIMIT","\"0.200\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_GAMMA_1_LOWERLIMIT","\"  0.020\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_GAMMA_2_LOWERLIMIT","\"  0.020\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_SYNC_ENABLED","\"1\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_SYNC_TIME","\"04:30:30\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_SYNC_LOWERLIMIT","\" 2\"",m_szIniFile);
	WritePrivateProfileString(UGRAND_DEFAULT,"SET_SYNC_UPPERLIMIT","\"5\"",m_szIniFile);
*/
}
