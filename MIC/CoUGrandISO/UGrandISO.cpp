...
//1
STDMETHODIMP CUGrandISO::AllowWriteToDisk(VARIANT_BOOL vb)
{
...
//2
STDMETHODIMP CUGrandISO::AppendGUIValues(BSTR bstrfilename)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//3
STDMETHODIMP CUGrandISO::CollectParametersForNewISO(
	BSTR *pbstrNameOut,
...
//4
STDMETHODIMP CUGrandISO::CreateISO(VARIANT_BOOL *pvbSuccess)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//5
STDMETHODIMP CUGrandISO::DriveBBMToZero(
...
//6
STDMETHODIMP CUGrandISO::EstablishButtonKeeperCommunicationsPath(
...
//7
STDMETHODIMP CUGrandISO::EstablishSpecialUPSCommunicationsPath(
...
//8
STDMETHODIMP CUGrandISO::EstablishValidationCommunicationsPath(
...
//9
STDMETHODIMP CUGrandISO::get_CurrentBBM(ULONG *pCurrentBBM)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//10
STDMETHODIMP CUGrandISO::get_ID(BSTR *pbstrID)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//11
STDMETHODIMP CUGrandISO::get_InShutDown(VARIANT_BOOL *pvbInShutDown)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//12
STDMETHODIMP CUGrandISO::get_InStartUp(VARIANT_BOOL *pvbInStartUp)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//13
STDMETHODIMP CUGrandISO::get_ISOCategory(ULONG *pCategory)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//14
STDMETHODIMP CUGrandISO::get_ISOTypeString(BSTR *pbstrTypeString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//15
STDMETHODIMP CUGrandISO::get_IsPaused(VARIANT_BOOL *pvbIsPaused)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//16
STDMETHODIMP CUGrandISO::get_FullName(BSTR *pbstrFullName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//17
STDMETHODIMP CUGrandISO::get_LastError(BSTR *pbstrErrorString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//18
STDMETHODIMP CUGrandISO::get_LocationAndExtensionsForDataFiles(
	BSTR *pbstrLocation,
...
//19
STDMETHODIMP CUGrandISO::get_Name(BSTR *pbstrName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//20
STDMETHODIMP CUGrandISO::get_VersionString(BSTR *pbstrVersion)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//21
STDMETHODIMP CUGrandISO::PauseInstrument(VARIANT_BOOL vbPauseCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//22
STDMETHODIMP CUGrandISO::put_DialogAutoCloseTime(ULONG seconds)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//23
STDMETHODIMP CUGrandISO::put_ICBPointer(IUnknown* pICB)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//24
STDMETHODIMP CUGrandISO::put_ICSOPointer(IUnknown* pICSO)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//25
STDMETHODIMP CUGrandISO::put_INIPathname(BSTR bstrINIPathname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//26
STDMETHODIMP CUGrandISO::put_LongNameFormatString(BSTR bstrFormatString)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[128];
	Convert_BSTR_to_Character_String(
...
//27
STDMETHODIMP CUGrandISO::put_MaximumRetryRepetitions(ULONG uNumberRepetitions)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//28
STDMETHODIMP CUGrandISO::put_Name(BSTR bstrName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[MAX_PATH];
...
//29
STDMETHODIMP CUGrandISO::put_NormalShutdown(VARIANT_BOOL vbNormalShutdown)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//30
STDMETHODIMP CUGrandISO::put_UTILPathname(BSTR bstrUTILPathname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	char string_out[MAX_PATH];
	Convert_BSTR_to_Character_String(
...
//31
STDMETHODIMP CUGrandISO::put_WindowsRegisteredMessageStrings(
	/*[in]*/ ULONG ulRECEIVE,
...
//32
STDMETHODIMP CUGrandISO::ResetISO()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	m_inst.Reset();
	return S_OK;
...
//33
STDMETHODIMP CUGrandISO::ShowISOGUI(VARIANT_BOOL vbCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//34
STDMETHODIMP CUGrandISO::ShutdownISO()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
//35
STDMETHODIMP CUGrandISO::UPSGoDumb()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	m_inst.GoDumb();
	return S_OK;
...
//36
STDMETHODIMP CUGrandISO::UseShortFilename(VARIANT_BOOL vbCommand)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
