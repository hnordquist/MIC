...
// User: Moore        Date: 11/14/05   Time: 3:50p
...
/////////////////////////////////////////////////////////////////////////////
// CJSRConfig2 property page

IMPLEMENT_DYNCREATE(CJSRConfig2, CPropertyPage)

CJSRConfig2::CJSRConfig2()
{
}

CJSRConfig2::CJSRConfig2(UINT id, CISO* pParent,bool DoingConfig) 
	: CPropertyPage(id)
{
	m_pParent = pParent;
	m_pPS = NULL;
...
void CJSRConfig2::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CJSRConfig2)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}
BEGIN_MESSAGE_MAP(CJSRConfig2, CPropertyPage)
	//{{AFX_MSG_MAP(CJSRConfig2)
	ON_BN_CLICKED(IDC_JSRCONFIG_APPLY,	OnJSRConfig2Apply)
	ON_BN_CLICKED(IDC_JSRCONFIG_DEFAULT,OnJSRConfig2Default)
	ON_WM_LBUTTONDOWN()
	ON_BN_CLICKED(IDC_JSRCONFIG_CURRENT,OnJSRConfig2Current)
	ON_BN_CLICKED(IDC_JSRCONFIG_CAMERAAPPLY,OnJSRCameraApply)
	...
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT1,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT2,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT3,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT4,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT5,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT6,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT7,	OnChangeConfigMost)
	ON_EN_CHANGE(IDC_JSRCONFIG_EDIT8,	OnChangeConfigMost)
	ON_WM_SHOWWINDOW()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CJSRConfig2::OnChangeConfigCameraPorts()
{
...
void CJSRConfig2::OnLButtonDown(UINT nFlags, CPoint point) 
{
	if (m_pPS)m_pPS->SetToClose(0);
	CPropertyPage::OnLButtonDown(nFlags, point);
}

void CJSRConfig2::SetPropertySheet(CJSRPropertySheet *pPS, bool bDoingConfig)
{
	m_pPS = pPS;
	m_bCollectingParametersForNewISO = bDoingConfig;
}

void CJSRConfig2::OnChangeConfigMost()
{
	if (m_pPS)m_pPS->SetToClose(0);
	...
	if (m_bInitDone && !m_bCollectingParametersForNewISO)
	{
		...
		GetDlgItem(IDC_JSRCONFIG_EDIT1)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT2)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT3)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT4)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT5)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT6)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT7)->EnableWindow(bEnable);
		GetDlgItem(IDC_JSRCONFIG_EDIT8)->EnableWindow(bEnable);
//		GetDlgItem(IDC_JSRCONFIG_DEFAULT)->EnableWindow(bEnable);
//		GetDlgItem(IDC_JSRCONFIG_CURRENT)->EnableWindow(bEnable);
	}
}

/////////////////////////////////////////////////////////////////////////////
// CJSRConfig2 message handlers
void CJSRConfig2::DoApply()
{
	if (m_pPS)m_pPS->SetToClose(0);
	...
	int Days = GetDlgItemInt(IDC_JSRCONFIG_EDIT1);
	int Hours= GetDlgItemInt(IDC_JSRCONFIG_EDIT2);
	int Min  = GetDlgItemInt(IDC_JSRCONFIG_EDIT3);
	int Sec  = GetDlgItemInt(IDC_JSRCONFIG_EDIT4);
	while (Sec >= 60) 
	{
		Sec -= 60;
		Min++;
	...
	Days = GetDlgItemInt(IDC_JSRCONFIG_EDIT5);
	Hours= GetDlgItemInt(IDC_JSRCONFIG_EDIT6);
	Min  = GetDlgItemInt(IDC_JSRCONFIG_EDIT7);
	Sec  = GetDlgItemInt(IDC_JSRCONFIG_EDIT8);
	while (Sec >= 60) 
	{
		Sec -= 60;
		Min++;
...
void CJSRConfig2::OnJSRCameraApply()
{
	if (m_pPS)m_pPS->SetToClose(0);
	...
	if (!m_bCollectingParametersForNewISO)
	{
		...
		if (m_pParent->Validate())
		{
			...
			//GetDlgItem(IDC_JSRCONFIG_CAMERAAPPLY)->EnableWindow(false);
...
void CJSRConfig2::OnJSRConfig2Apply() 
{
	if(m_pPS)m_pPS->SetToClose(0);

	if (m_pParent->Validate())
	{
		((CJSRModParam*)m_pPS->GetPage(0))->DoApply();
		DoApply();
	}
}

void CJSRConfig2::BlockCamera()
{
	...
	GetDlgItem(IDC_JSRCONFIG_EDIT1)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT2)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT3)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT4)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT5)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT6)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT7)->EnableWindow(false);
	GetDlgItem(IDC_JSRCONFIG_EDIT8)->EnableWindow(false);
}


void CJSRConfig2::SaveItem(char *szName, char *szItem, int dDlgItem)
{
...
void CJSRConfig2::OnJSRConfig2Current() 
{
	if (m_pPS)m_pPS->SetToClose(0);
	...
	else
	{
		...
		GetDlgItem(IDC_JSRCONFIG_EDIT1)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT2)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT3)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT4)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT5)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT6)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT7)->EnableWindow(true);
		GetDlgItem(IDC_JSRCONFIG_EDIT8)->EnableWindow(true);
	}
}

void CJSRConfig2::OnJSRConfig2Default()
{
	if (m_pPS)
		m_pPS->SetToClose(0);

	OnJSRConfig(JSR_DEFAULT);
...
void CJSRConfig2::OnJSRConfig(char *Name)
{
	char temp[_MAX_PATH];
...
//	SetDlgItemInt(IDC_CAMERATRIGTHRESH,TrigThreshRate);	
	...
	SetDlgItemInt(IDC_JSRCONFIG_EDIT1,Day);
	SetDlgItemInt(IDC_JSRCONFIG_EDIT2,Hour);
	SetDlgItemInt(IDC_JSRCONFIG_EDIT3,Min);
	SetDlgItemInt(IDC_JSRCONFIG_EDIT4,Sec);
	...
	SetDlgItemInt(IDC_JSRCONFIG_EDIT5,Day);
	SetDlgItemInt(IDC_JSRCONFIG_EDIT6,Hour);
	SetDlgItemInt(IDC_JSRCONFIG_EDIT7,Min);
	SetDlgItemInt(IDC_JSRCONFIG_EDIT8,Sec);
}

BOOL CJSRConfig2::OnSetActive() 
{
//	TRACE("CJSRConfig2::OnSetActive\n");
	...
	if (m_bCollectingParametersForNewISO)
	{
		...
		GetDlgItem(IDC_JSRCONFIG_CURRENT)->ShowWindow(SW_HIDE);
	...
	else
	{
		...
		GetDlgItem(IDC_JSRCONFIG_CURRENT)->ShowWindow(SW_SHOW);
	}
	BOOL result = CPropertyPage::OnSetActive();
	return result;
}

BOOL CJSRConfig2::OnWizardFinish() 
{
...
//	((CEdit*)GetDlgItem(IDC_CAMERATRIGTHRESH))->SetLimitText(4);
	...
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT1))->SetLimitText(2);
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT2))->SetLimitText(2);
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT3))->SetLimitText(2);
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT4))->SetLimitText(2);

	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT5))->SetLimitText(2);
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT6))->SetLimitText(2);
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT7))->SetLimitText(2);
	((CEdit*)GetDlgItem(IDC_JSRCONFIG_EDIT8))->SetLimitText(2);
...
void CJSRConfig2::OnButtonTestport() 
{
...
void CJSRConfig2::OnTimer(UINT nIDEvent) 
{
...
void CJSRConfig2::OnShowWindow(BOOL bShow, UINT nStatus) 
{
