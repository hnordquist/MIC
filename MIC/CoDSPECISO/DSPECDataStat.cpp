...
void CDSPECDataStat::OnShowSpectra()
{
	if (m_pParent->Validate(true)) //superuser = true
	{
		...
		WritePrivateProfileString(m_pPropertySheet->m_pParent->m_pName,SHOW_SPECTRA,
			itoa(m_iShowSpectra,szTemp,10),m_szIniFile);
	}
	ShowWindow(SW_SHOW);
