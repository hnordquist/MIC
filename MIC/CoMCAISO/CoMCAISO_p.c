...
const CInterfaceProxyVtbl * _CoMCAISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * _CoMCAISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoMCAISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  _CoMCAISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoMCAISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoMCAISO, pIID, n)

int __stdcall _CoMCAISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoMCAISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoMCAISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoMCAISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoMCAISO_StubVtblList,
    (const PCInterfaceName * ) & _CoMCAISO_InterfaceNamesList,
    (const IID ** ) & _CoMCAISO_BaseIIDList,
    & _CoMCAISO_IID_Lookup, 
    1,
    2,
