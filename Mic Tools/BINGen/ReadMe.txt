========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : WinDump
========================================================================


AppWizard has created this WinDump application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your WinDump application.
...
res\WinDump.ico
    ...
    icon is included by the main resource file WinDump.rc.
...
WinDumpDlg.h, WinDumpDlg.cpp - the dialog
    These files contain your CWinDumpDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in WinDump.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CWinDumpDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named WinDump.pch and a precompiled types file named StdAfx.obj.
